...
var _interopRequiredWildcard = require("@babel/runtime/helpers/interopRequireWildcard");
...
var React = _interopRequiredWildcard(require("react"));

var _propTypes = _interopRequireDefault(require("prop-types"));

var ReactDOM = _interopRequiredWildcard(require("react-dom"));
...
var ButtonBase = /*#__PURE__*/React.forwardRef(function ButtonBase(props, ref) {
    var action = props.action,
        ...
        disableTouchRipple = _props$disableTouchRi === void 0 ? false :
    ...
    var handleFocus = (0, _useEventCallback.default)(function (event) {
        // Fix reference for https://github.com/facebook/react/issues/7769
    ...
    if(process.env.NODE_ENV !== 'production') {
        ...
        React.useEffect(function () {
            if(enableTouchRipple && !rippleRef.current) {
                console.error(['Qodev-UI: The `component` prop provided to ButtonBase is invalid.', 'Please make sure the children prop is rendered in this custom component.'].join('\n'));
            }
        }, [enableTouchRipple]);
    }
