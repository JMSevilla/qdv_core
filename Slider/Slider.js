...
process.env.NODE_ENV !== "production" ? Slider.propTypes = {
  ...
  'aria-label': (0, _utils.chainPropTypes)(_propTypes.default.string, function (props) {
    ...
    if (range && props['aria-label'] != null) {
      return new Error('Qodev-UI: You need to use the `getAriaLabel` prop instead of `aria-label` when using a range slider.');
    }
  ...
  'aria-valuetext': (0, _utils.chainPropTypes)(_propTypes.default.string, function (props) {
    ...
    if (range && props['aria-valuetext'] != null) {
      return new Error('Qodev-UI: You need to use the `getAriaValueText` prop instead of `aria-valuetext` when using a range slider.');
    }
