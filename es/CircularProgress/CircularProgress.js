...
process.env.NODE_ENV !== "production" ? CircularProgress.propTypes = {
  ...
  disableShrink: chainPropTypes(PropTypes.bool, props => {
    if (props.disableShrink && props.variant && props.variant !== 'indeterminate') {
      return new Error('Qodev-UI: You have provided the `disableShrink` prop ' + 'with a variant other than `indeterminate`. This will have no effect.');
    }
  ...
  variant: chainPropTypes(PropTypes.oneOf(['determinate', 'indeterminate', 'static']), props => {
    ...
    if (variant === 'static') {
      throw new Error('Qodev-UI: `variant="static"` was deprecated. Use `variant="determinate"` instead.');
    }
