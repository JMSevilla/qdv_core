  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    registerEffect = () => {
      if (registeredInput.current) {
        console.error(['Qodev-UI: There are multiple InputBase components inside a FormControl.', 'This is not supported. It might cause infinite rendering loops.', 'Only use one InputBase.'].join('\n'));
      }
