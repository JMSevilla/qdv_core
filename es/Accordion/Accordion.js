...
process.env.NODE_ENV !== "production" ? Accordion.propTypes = {
  ...
  children: chainPropTypes(PropTypes.node.isRequired, props => {
    ...
    if (isFragment(summary)) {
      return new Error("Qodev-UI: The Accordion doesn't accept a Fragment as a child. " + 'Consider providing an array instead.');
    }

    if (! /*#__PURE__*/React.isValidElement(summary)) {
      return new Error('Qodev-UI: Expected the first child of Accordion to be a valid element.');
    }
