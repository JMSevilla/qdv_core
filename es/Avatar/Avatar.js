...
process.env.NODE_ENV !== "production" ? Avatar.propTypes = {
  ...
  classes: chainPropTypes(PropTypes.object, props => {
    ...
    classes.circle.split(' ').length > 1) {
      throw new Error(`Qodev-UI: The \`circle\` class is deprecated. Use \`circular\` instead.`);
    }
  ...
  variant: chainPropTypes(PropTypes.oneOf(['circle', 'circular', 'rounded', 'square']), props => {
    ...
    if (variant === 'circle') {
      throw new Error('Qodev-UI: `variant="circle"` is deprecated. Use `variant="circular"` instead.');
    }
