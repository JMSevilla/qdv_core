...
process.env.NODE_ENV !== "production" ? IconButton.propTypes = {
  ...
  children: chainPropTypes(PropTypes.node, props => {
    ...
    if (found) {
      return new Error(['Qodev-UI: You are providing an onClick event listener ' + 'to a child of a button element.', 'Firefox will never trigger the event.', 'You should move the onClick listener to the parent button element.', 'https://github.com/mui-org/material-ui/issues/13957'].join('\n'));
    }
