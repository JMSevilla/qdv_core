...
/**
 * Qodev-UI components have a `className` prop. The `className` is applied to
 * the root component.
 *
...
/**
 * Qodev-UI components have a `component` prop that allows rendering a different
...
/**
 * Qodev-UI components can spread additional props to a documented component.
 ...
 * @property {Record<string, string>} classes - `classes` of the component provided by `@qodev/styles`
...
/**
 * Tests various aspects of a component that should be equal across Qodev-UI
 * components.
 *
...
function describeConformance(minimalElement, getOptions) {
  ...
  describe('Qodev-UI component API', function () {
    after(runAfterHook);
