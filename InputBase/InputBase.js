...
var InputBase = /*#__PURE__*/React.forwardRef(function InputBase(props, ref) {
  ...
  var handleChange = function handleChange(event) {
    if (!isControlled) {
      ...
      if (element == null) {
        throw new Error(process.env.NODE_ENV !== "production" ? "Qodev-UI: Expected valid input target. Did you use a custom `inputComponent` and forget to forward refs? See https://mui.com/r/input-component-ref-interface for more info." : (0, _utils.formatQdvErrorMessage)(1));
      }
