...
var LinearProgress = /*#__PURE__*/React.forwardRef(function LinearProgress(props, ref) {
  ...
  if (variant === 'determinate' || variant === 'buffer') {
    if (value !== undefined) {
      ...
      console.error('Qodev-UI: You need to provide a value prop ' + 'when using the determinate or buffer variant of LinearProgress .');
    }
  }
  ...
  if (variant === 'buffer') {
    if (valueBuffer !== undefined) {
      ...
      console.error('Qodev-UI: You need to provide a valueBuffer prop ' + 'when using the buffer variant of LinearProgress.');
    }
  }
