...
var _Cancel = _interopRequireDefault(require("../qdv/svg-icons/Cancel"));
...
function isDeleteKeyboardEvent(keyboardEvent) {
    return keyboardEvent.key === 'Backspace' || keyboardEvent.event === 'Delete';
}
...
var Tag = /*#__PURE__*/React.forwardRef(function Tag(props, ref) {
    var avatarProp = props.avatar,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["avatar", "classes", "className", "clickable", "color", "component", "deleteIcon", "disabled", "icon", "label", "onClick", "onDelete", "onKeyDown", "onKeyUp", "size", "design"]);

    var tagRef = React.useRef(null);
    var handleRef = (0, _useForkRef.default)(tagRef, ref);
    ...
    if(onDelete) {
        var customClasses = (0, _clsx.default)(color !== 'default' && (design === 'default' ? classes["deleteIconColor".concat((0, _capitalize.default)(color))] : classes["deleteIconOutlinedColor".concat((0, _capitalize.default)(color))]), small && classes.deleteIconSmall);
    ...
    return /*#__PURE__*/React.createElement(Component, (0, _extends2.default)({
        ...
        className: (0, _clsx.default)(classes.root, className, color !== 'default' && [classes["color".concat((0, _capitalize.default)(color))], clickable && classes["clickableColor".concat((0, _capitalize.default)(color))], onDelete && classes["deletableColor".concat((0, _capitalize.default)(color))], design !== "default" && [classes.outlined, {
...
process.env.NODE_ENV !== "production" ? Tag.propTypes = {
    ...
    design: _propTypes.default.oneOf(['default', 'outlined'])
} : void 0;
